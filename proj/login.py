...
def login():
    ...
    # get whether or not they want to submit
    # Adding the if statement in case Paul tells me to get rid of it, that way getting rid of that in the html form wont break the code here
